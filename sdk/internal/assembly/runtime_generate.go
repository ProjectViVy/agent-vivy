...
func GenerateRuntimeAssembly(plan AssemblyPlan, packageName string) ([]byte, error) {
	...
	var moduleIDs, channelNames, toolIDs, worldIDs, contextSourceIDs, skillSourceIDs []string
	...
	var toolsExpr []providerExpression
	...
	for _, resolved := range modules {
		...
		hasTool, hasWorld, hasChannel, hasContextSource, hasSkillSource := false, false, false, false, false
