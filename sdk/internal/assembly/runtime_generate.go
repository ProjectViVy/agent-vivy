...
func GenerateRuntimeAssembly(plan AssemblyPlan, packageName string) ([]byte, error) {
	...
	var moduleIDs, channelNames, toolIDs, worldIDs, providerProfileIDs, contextSourceIDs, skillSourceIDs []string
	...
	for _, resolved := range modules {
		...
		hasTool, hasWorld, hasChannel, hasProfile, hasContextSource, hasSkillSource := false, false, false, false, false, false
