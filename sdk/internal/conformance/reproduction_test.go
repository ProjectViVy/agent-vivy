...
func releaseSuiteCases(internalDigest string) []releaseSuiteCase {
	...
	cases := []releaseSuiteCase{
		...
		{"std/face@v1", "vivy/headless", "faces/headless", "a7dde271b69e1701a40dbfd4fb8ce63d4a65b7481a4b562b82e64c0578d153d4", "faces/headless/headless_test.go#TestCompletedRunStreamsAndReturnsStatus", nested("faces/headless")},
