...
func releaseSuiteCases() []releaseSuiteCase {
	internalSHA := "9bc6ebd5c884faf7186fea0bc5fd3706f3b6302f791c00d4421997250ff23206"
	...
	cases := []releaseSuiteCase{
		...
		{"std/channel@v1", "vivy/dingtalk", "plugins/dingtalk", "a2ccc0d61d0a88378855d2b0f5a1b4870ab3fbb5b6efc25550ec34c1cc21e58c", "plugins/dingtalk/plugin_test.go#TestStartStopFullLoop", nested("plugins/dingtalk")},
		{"std/channel@v1", "vivy/discord", "plugins/discord", "4715b2c2c8ed61cba34d2dfc95a9da0730850c0b52b92372d69482f4aaa9a40e", "plugins/discord/plugin_test.go#TestStartSuccessWiring", nested("plugins/discord")},
		{"std/channel@v1", "vivy/feishu", "plugins/feishu", "0f6b498d4aa9fa6199847386b860a0842343d150cdf6e32cc3c28a89f8efa3a7", "plugins/feishu/plugin_test.go#TestStartStopFullLoop", nested("plugins/feishu")},
		{"std/channel@v1", "vivy/qq", "plugins/qq", "320e59a0c275ec17cf17aa754360b9af5837592a477b96a3d86513f16957f97b", "plugins/qq/plugin_test.go#TestSendPassiveReplyLoopback", nested("plugins/qq")},
		{"std/channel@v1", "vivy/telegram", "plugins/telegram", "61436c68739d41d8583bbfbb993bf7949b1a4da32235edbe80067bb2ef5f8d41", "plugins/telegram/plugin_test.go#TestStartStopFullLoop", nested("plugins/telegram")},
