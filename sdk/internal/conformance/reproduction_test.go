...
func releaseSuiteCases(internalDigest string) []releaseSuiteCase {
	...
	cases := []releaseSuiteCase{
		...
		{"std/tool-world@v1", "vivy/lsp", "plugins/lsp", "d8a8e2d802f607fb22a42f80570ea13b0a3013269ba8e81155f2622e19c87f2c", "plugins/lsp/plugin_test.go#TestDiagnosticsToolEndToEnd", nested("plugins/lsp")},
		{"std/channel@v1", "vivy/dingtalk", "plugins/dingtalk", "cfeed32ac0746681abdd2b754b7b1c93f444fe92c821eabbc5aa8ed2f7c02e23", "plugins/dingtalk/plugin_test.go#TestStartStopFullLoop", nested("plugins/dingtalk")},
		{"std/channel@v1", "vivy/discord", "plugins/discord", "175469f9668ddb395741f4cd67675ff5d54975294428dbdd2d1c7ea61e0cadfa", "plugins/discord/plugin_test.go#TestStartSuccessWiring", nested("plugins/discord")},
		{"std/channel@v1", "vivy/feishu", "plugins/feishu", "d99bfea7ce2257d4a71b6a1b4a2afd2e76c41533876db2c6b32f1c7c0d725d94", "plugins/feishu/plugin_test.go#TestStartStopFullLoop", nested("plugins/feishu")},
		{"std/channel@v1", "vivy/qq", "plugins/qq", "d201b30ff008a22cc685d29e0b6a72a35ff486d882d048adec7cc2d216beb0ab", "plugins/qq/plugin_test.go#TestSendPassiveReplyLoopback", nested("plugins/qq")},
		{"std/channel@v1", "vivy/telegram", "plugins/telegram", "4241491cf710d5d5b6a50a2670660d3c4cd849b869092004267ec4907991fe60", "plugins/telegram/plugin_test.go#TestStartStopFullLoop", nested("plugins/telegram")},
		{"std/face@v1", "vivy/headless", "faces/headless", "cc0773ad1753006a9a6d04978b8653e08312d7c4ed9733f4474b21d7bfff8b5a", "faces/headless/headless_test.go#TestCompletedRunStreamsAndReturnsStatus", nested("faces/headless")},
		{"std/face@v1", "vivy/tui", "faces/tui", "456e4dd9975d4f8baa3846f62232023a6412f4f6d7272f013b0e3aad4ad1f3d8", "faces/tui/face_test.go#TestNewDelegatesCanonicalTUI", nested("faces/tui")},
		...
		{"std/middleware/pre-tool@v1", "vivy/governance-reference", "plugins/governance", "7000dd87b89aa76b4dad29a49ebd2beff5ecdbb3afe0a9d8d695f6ffb488f5e2", "plugins/governance/provider_test.go#TestReferenceProviderConformance", nested("plugins/governance")},
		{"std/observer/run@v1", "vivy/governance-reference", "plugins/governance", "7000dd87b89aa76b4dad29a49ebd2beff5ecdbb3afe0a9d8d695f6ffb488f5e2", "plugins/governance/provider_test.go#TestReferenceProviderConformance", nested("plugins/governance")},
		{"std/observer/run@v1", "scx/reference-fixtures", "plugins/scx-reference", "fa85239d62b12bc8ce880bae5e2e9c15ba3a7d3986d14c4fc23db2cbeba203ae", "internal/observerhost/scx_conformance_test.go#TestSCXObserverWorkerResumesPendingDeliveryAfterReconnect", append(nested("plugins/scx-reference"), releaseTestCommand{Package: "./internal/observerhost", Run: "^TestSCXObserverWorkerResumesPendingDeliveryAfterReconnect$"})},
		{"std/observer/diagnostic@v1", "vivy/governance-reference", "plugins/governance", "7000dd87b89aa76b4dad29a49ebd2beff5ecdbb3afe0a9d8d695f6ffb488f5e2", "plugins/governance/provider_test.go#TestReferenceProviderConformance", nested("plugins/governance")},
		{"std/status-source@v1", "vivy/governance-reference", "plugins/governance", "7000dd87b89aa76b4dad29a49ebd2beff5ecdbb3afe0a9d8d695f6ffb488f5e2", "plugins/governance/provider_test.go#TestReferenceProviderConformance", nested("plugins/governance")},
