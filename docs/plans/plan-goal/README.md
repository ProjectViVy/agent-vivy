...
Pre-design checks are recorded in [2026-09-21 verification](../../logs/2026-09-21-plan-goal-predesign/verification.md). Foundation evidence is in [2026-09-23 verification](../../logs/2026-09-23-plan-goal-foundation/verification.md). The latest integrated full `just ci` passed at `1aca64f` and is recorded in [PG-6 verification](../../logs/2026-09-25-pg6-integrated-acceptance/verification.md). PostgreSQL validation is user-deferred; browser acceptance is user-owned; the PG-6 live-provider coding walkthrough remains unverified.
