...
> Historical acceptance snapshot (2026-09-06), superseded by PLG-P4 closure
> on 2026-09-11. The `mcp_call`/`PrepareMCPCall` wording below describes the
> pre-P4 model surface, not the current ToolHost route.
