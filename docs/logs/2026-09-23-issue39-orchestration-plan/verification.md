...
- Follow-up review of #39 inventory comment `5754140743` found a separate bounded parent-child messaging candidate. Updated D8 to distinguish mailbox delivery to an active child from later-Run `child/followup` and peer/swarm messaging; no implementation choice was made.
