...
These behaviors are exercised by the runtime probes and storage conformance suite linked in [verification](verification.md). Product-facing Plan/Goal controls and live-database/browser acceptance remain part of later gates.
