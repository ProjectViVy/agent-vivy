...
| 14a | `agent-vivy/docs/architecture/VIVY-CHANNEL-PACK.md` | **Adopted 2026-08-30.** Super-channel Host in kernel; this batch of adapters are `plugins/` with `seam: channel`; config cannot grow new adapters; A2A/NeuroLink reserved | When discussing Telegram/Feishu/QQ/DingTalk/Discord, A2A, NeuroLink, or "built-in plugins" |
