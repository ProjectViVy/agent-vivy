...
> **PLG-1 normative ruling (updated 2026-09-13):** P0 is a documentation-only
...
> P3 and P7 are complete, and the human owner scheduled P8 on 2026-09-13. P8
> Gates A/B/C passed for bounded fixtures A-C and the selected SCX candidate.
> P9 remains `UNSCHEDULED` as a full release-conformance phase; the owner
> authorized the selected P9 matrix consumed by P8 Gate C. Sources of truth are
...
| PLG-1 | Complete PLUGINS v1 | P0 DOCS COMPLETE · P1–P8 COMPLETE · P9 UNSCHEDULED | See `docs/plans/plugin-platform/README.md`. P8 Gates A/B/C passed for bounded fixtures A-C using the explicitly authorized selected P9 release matrix; this does not schedule or close full PLG-P9. |
