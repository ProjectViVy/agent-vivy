...
type DynamicCommand = shared.DynamicCommand
type DynamicCommandArgument = shared.DynamicCommandArgument
type DynamicCommandProvider = shared.DynamicCommandProvider
type DynamicCommandRefresher = shared.DynamicCommandRefresher
type DynamicCommandsMsg = shared.DynamicCommandsMsg
type DynamicCommandExecutor = shared.DynamicCommandExecutor
type DynamicCommandExpandedMsg = shared.DynamicCommandExpandedMsg
