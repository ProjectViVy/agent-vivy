...
// migration016 adds the control plane's scheduled jobs (the CRON panel
// backend). Schedule and payload stay backend-owned JSON columns so the
// domain shapes can evolve without schema churn.
const migration016 = `
