...
export default defineConfig({
  ...
  webServer: { command: `${JSON.stringify(goExe)} run ./cmd/vivy`, cwd: repoRoot, url: `http://${E2E_ADDR}/healthz`, env: { ...process.env, VIVY_ADDR: E2E_ADDR, VIVY_CONFIG: e2eConfig }, reuseExistingServer: false, timeout: 120_000 },
});
