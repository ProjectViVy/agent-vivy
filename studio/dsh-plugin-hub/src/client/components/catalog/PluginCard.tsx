...
import { fmtStars, relTime } from '../../logic/format.ts'

export function PluginCard({ plugin: p, copied, installedName, installedVersion, t, langKey, langPath, onInstall, onUninstall }: {
  plugin: HubPlugin
  copied: string | null
