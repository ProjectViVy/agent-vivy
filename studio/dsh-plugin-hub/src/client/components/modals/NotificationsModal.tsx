...
export function NotificationsModal({ records, tasks, pendingRestarts, t, env, onClose, onCopy, onClear, onRemove, cancelTask, restarting, onRestart, resolveRepo }: {
                ...
                h('div', { className: styles.noticeMain },
                  h('div', { className: styles.noticeHead },
                    ...
                    r.ok
                      ...
                      : null,
                    // 更新提醒：行尾不再提供「去更新 / 忽略本次更新」按钮（本构建无升级路径）
