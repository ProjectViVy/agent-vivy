...
export const zh = {
  nav: '插件中心',
  title: 'VIVY-STUDIO-PLUGIN-HUB',
  // 收录/精选数量由组件从官网 /api/stats.json 实时拉取填充（{total}/{verified}），不写死
  tagline: 'VIVY-STUDIO-PLUGIN-HUB：Vivy Studio 插件中心，浏览并安装社区插件（基于 dsh-plugin-hub 魔改）',
  search: '搜索插件名称、描述、标签…',
  all: '全部',
  sortStars: 'Star',
  sortForks: 'Fork',
  ...
  retry: '重试',
  install: '安装',
  // AI 识别可能需要命令行辅助的插件（webInstallable=false）：仍可尝试一键安装；本构建不复制终端命令
  cliOnlyHint: '此插件可能需要命令行辅助；若一键安装失败，可查看插件仓库 README 说明',
  vivyInstallCmdNote: '由 VIVY-STUDIO-PLUGIN-HUB 自动安装：GitHub 插件克隆到 Vivy 源码树 studio/ 目录并注册为本地 bundle',
  failedCopyHint: '安装失败。请查看上方错误信息，或前往插件仓库反馈（本构建不引导终端命令）',
  toastCopied: '已复制',
  installed: '已安装',
  ...
  dshCmdPlaceholder: '粘贴官方 dsh plugin add 命令',
  dshCmdExample: '例如：dsh plugin --profile <profile> add github:owner/repo',
  dshCmdInvalid: '请输入官方 dsh plugin add 命令（--profile 必填，仅支持 add）。例如：dsh plugin --profile <profile> add github:owner/repo',
  installHelp: '帮助',
  ...
  // 设置视图：网络与通道 / 安全与信任 / 诊断 / 系统日志
  settingsUpdate: '网络与通道',
  settingsUpdateDesc: 'npm 镜像源与 HTTP 代理等安装网络通道',
  ...
  settingsVivySource: 'Vivy 源码安装',
  settingsVivySourceDesc: '在 Vivy Studio 中把 GitHub 插件克隆到 Vivy 仓库的 studio/ 目录并注册为本地 bundle；关闭后走官方 dsh plugin 系统目录安装',
  ...
  // 恢复默认：一级菜单 + 独立设置卡片
  settingsReset: '恢复默认',
  settingsResetDesc: '镜像源、代理与安全限制一次性恢复为出厂默认值',
  settingsResetDetail: '恢复镜像源、代理与安全限制为出厂默认值',
  settingsResetRun: '恢复默认',
  settingsResetConfirm: '确认恢复',
  settingsResetConfirmDetail: '确定要恢复默认设置吗？镜像源、代理与安全限制将全部回到出厂默认值。',
  // 启动更新策略提示
  ...
  notifications: '通知',
  notificationsHint: '查看安装/卸载通知',
  notificationsDesc: '安装、卸载任务都会记录在这里，即使错过提示也能随时回来查看。',
  ...
  hubUpToDate: '已是最新版本',
  // 头部「关于」弹窗：本地固定文案（项目定位 + 引用原作者 dsh-plugin-hub）
  followUs: '关于',
  aboutTitle: '关于 VIVY-STUDIO-PLUGIN-HUB',
  aboutDesc: '了解 VIVY-STUDIO-PLUGIN-HUB 的定位与原作者出处。',
...
export const en = {
  ...
  tagline: 'VIVY-STUDIO-PLUGIN-HUB: the Vivy Studio plugin marketplace — fork of dsh-plugin-hub',
  adBadge: 'Featured',
  ad: 'VIVY-STUDIO-PLUGIN-HUB: {total} plugins indexed, {verified} human-verified, updated daily',
  ...
  // no terminal command is offered in this sealed build
  cliOnlyHint: 'This plugin may need command-line help; if one-click install fails, check the plugin repository README',
  vivyInstallCmdNote: 'Installed automatically by VIVY-STUDIO-PLUGIN-HUB: GitHub plugins are cloned into the Vivy source tree (studio/) and registered as local bundles',
  failedCopyHint: 'Install failed. Review the error above or report it to the plugin repository (this build does not offer terminal commands)',
  toastCopied: 'Copied',
  installed: 'Installed',
  ...
  dshCmdExample: 'e.g. dsh plugin --profile <profile> add github:owner/repo',
  dshCmdInvalid: 'Paste an official dsh plugin add command (--profile required, add only), e.g. dsh plugin --profile <profile> add github:owner/repo',
  installHelp: 'Help',
  ...
  gitInstallHelp: 'owner/repo\nhttps://github.com/owner/repo\ngithub:owner/repo\ngit+https://github.com/owner/repo.git\ngit@github.com:owner/repo.git',
  dshCmdHelp: 'dsh plugin --profile <profile> add <target>\tinstall\ndsh plugin --profile=<profile> add <target>\n\t--profile is required and there is no -p shorthand (add only in this build); <target> can be an npm package or github:owner/repo; uninstall from the Installed list',
  ...
  settingsUpdate: 'Network & Channels',
  settingsUpdateDesc: 'npm registry mirror and HTTP proxy used by installs',
  ...
  settingsVivySource: 'Vivy source install',
  settingsVivySourceDesc: 'In Vivy Studio, clone GitHub plugins into the Vivy repository under studio/ and register them as local bundles; turning this off uses the official dsh plugin system-directory install',
  ...
  settingsResetDesc: 'Restore npm mirror, proxy and security restrictions to factory defaults in one go',
  settingsResetDetail: 'Reset npm mirror, proxy and security restrictions to factory defaults',
  settingsResetRun: 'Restore Defaults',
  settingsResetConfirm: 'Restore Defaults',
  settingsResetConfirmDetail: 'Reset all settings to factory defaults? npm mirror, proxy and security restrictions will be cleared.',
  ...
  notificationsHint: 'View install/remove notifications',
  notificationsDesc: 'Every install and remove notice is logged here — even if you missed the prompt, you can always check back.',
  ...
  followUs: 'About',
  aboutTitle: 'About VIVY-STUDIO-PLUGIN-HUB',
  aboutDesc: 'What VIVY-STUDIO-PLUGIN-HUB is and where it comes from.',
